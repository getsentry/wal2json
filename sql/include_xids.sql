...
-- Two rows in one transaction should have two record and twice the same xid
INSERT INTO tbl VALUES (4), (5);
SELECT count(*) = 2, count(((data::json)->'xid')::text) = 2 FROM pg_logical_slot_get_changes('regression_slot', NULL, NULL, 'include-xids', '1');
